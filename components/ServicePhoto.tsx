...
const serviceImages: Record<string, string> = {
  ...
  Detailing: "dk-ncr-detailing-at-home-category-v1.webp",
  "Premium Detailing": "dk-ncr-detailing-at-home-polisher-v2.webp",
  "Interior Cleaning": "dk-ncr-interior-cleaning-v1.webp",
  "Interior Mods": "interior-mods-ncr-home-bg-v2.webp",
  "Interior Upgrades": "bmw-luxury-interior.jpg",
  "Exterior Mods": "exterior-mods-ncr-home-bg-v2.webp",
  "Exterior Styling": "exterior-mods-bmw-jdm.webp",
  Protection: "protective-film-team.jpg",
  "Protection Packages": "ppf-install.jpg",

  // Detailing services
  "Exterior Detailing": "dk-ncr-exterior-detailing-v1.webp",
  "Deep Interior Cleaning": "deep-interior-cleaning-dyson-v2.webp",
  "Deep Steam Interior Cleaning and Sanitisation": "dk-ncr-steam-sanitisation-v1.webp",
  "Deep Interior Detailing": "deep-interior-detailing-brush-v2.webp",
  "Deep Seat Cleaning": "deep-seat-cleaning-ai.png",
  "Leather Cleaning and Conditioning": "dk-ncr-leather-conditioning-v1.webp",
  "Dashboard and Trim Detailing": "dashboard-trim-ai.png",
  "Deep AC Vent Cleaning": "dk-ncr-dashboard-vent-v1.webp",
  "Deep Carpet and Floor Cleaning": "carpet-floor-dyson-v2.webp",
  "Deep Headliner / Roof Cleaning": "dk-ncr-headliner-v1.webp",
  "Deep Boot Cleaning": "deep-boot-cleaning-v2.webp",
  "Window Detailing": "dk-ncr-glass-detailing-v1.webp",
  "Premium Glass Polish": "glass-cleaning.jpg",
  "Door Jamb Detailing": "door-jamb-cleaning.jpg",
  "Engine Bay Detailing": "dk-ncr-engine-bay-v1.webp",
  "Tyre and Alloy Detailing": "dk-ncr-wheel-detailing-v1.webp",
  "Premium Machine Wax": "paint-polish-door.jpg",
  "Premium Paint Decontamination": "clay-bar-decontamination-v2.webp",
  "Clay Bar Decontamination": "dk-ncr-clay-bar-v1.webp",
  "Premium Paint Gloss Enhancement": "paint-gloss-enhancement-v2.webp",
  "Single Stage Paint Correction": "paint-correction.jpg",
  "Multi Stage Paint Correction": "dk-ncr-paint-correction-v1.webp",
  "Swirl Mark Removal": "paint-polish.jpg",
  "Deep Paint Revival": "water-beading.jpg",
  "Odour Neutralisation": "cabin-fragrance.jpg",
  "Cabin Sanitisation": "dk-ncr-cabin-sanitisation-v1.webp",
  ...
  "Heads-Up Display (HUD)": "modern-digital-dashboard.jpg",
  "Custom Floor Mats": "custom-floor-mat.jpg",
  "USB Fast Charging Ports": "dashboard-screen.jpg",
  "Dash Camera Installation": "dash-camera.jpg",
  "Rear Seat Display": "rear-seat-display-ai.png",

  // Exterior mods
  "Gloss Black Roof Wrap": "gloss-black-roof-wrap-ncr-home-v1.webp",
